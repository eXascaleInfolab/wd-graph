...
parser = argparse.ArgumentParser(description='Start Wikidata Server.')
parser.add_argument('--endpoint', '-e', default="ipc:///tmp/wikidata", help='the zmq endpoint to listen to (default ipc:///tmp/wikidata)')
parser.add_argument('--graph', '-g', default="wikidata-20170424-all.json.bz2.universe.gt.bz2", help='the graph to load')
